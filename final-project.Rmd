...
recent_drug <- import(here("data", "2015_drug_dep.csv"),
                      setclass = "tbl_df")
#great job using the here package, I always forget to use this, but it is so helpful when sharing code
```
...
```{r create-list}
#great intro to your tutorial, your writing is very clear
...
#I think there is a global setting where you can have knit render even when there is an error
```
...
#How will you demonstrate that map gives you a list? You'll want to make sure this is clear to the reader and maybe give a brief descrition of what a list is
```
...
#Here a short description of coercing may be helpful to the reader
```
...
#I like your description of x as a place holder, this is a new way of characterizing the elements of a function for me
...
#I like your inclusion of examples that don't work to help the reader problem solve
...
#For me parallel iteration is always more difficult to understand without a plot, you may consider what visualization might aide your example
```
...
#I always struggle with walk and your example helped make its purpose clearer
```
...
#great work wrangling the data to get it in a useable form
...
#this is a long example, consider how your might break it up to keep the reader engaged
```
...
```{r eval=FALSE}
#function mispelled above
#Your function examples have a lot of text, consider how you will break them up with code or visualizations. 
